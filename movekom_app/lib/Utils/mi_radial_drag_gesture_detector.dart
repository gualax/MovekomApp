...
class MyRadialDragGestureDetector extends StatefulWidget {
  ...
  @override
  _MyRadialDragGestureDetectorState createState() =>
      new _MyRadialDragGestureDetectorState();
}

class _MyRadialDragGestureDetectorState extends State<MyRadialDragGestureDetector> {
