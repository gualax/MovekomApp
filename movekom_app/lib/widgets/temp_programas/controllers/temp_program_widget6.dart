...
class TimerProgramWidget6 extends StatefulWidget {
  int widgetType;

  TimerProgramWidget6(this.widgetType);

  @override
  _TimerProgramWidget6State createState() => _TimerProgramWidget6State();
}

class _TimerProgramWidget6State extends State<TimerProgramWidget6> {
  String title = "PROGRAMA 6";
  List<String> daysAdded = new List();
  TimerProgram6Bloc bloc;
  ...
  Widget build(BuildContext context) {
    bloc = BlocProvider.of<TimerProgram6Bloc>(context);
  ...
  Widget timer_program_widget() {
    ...
    return BlocBuilder<TimerProgram6Bloc, TimerProgram6State>(
