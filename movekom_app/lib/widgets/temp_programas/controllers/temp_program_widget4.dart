...
class TimerProgramWidget4 extends StatefulWidget {
  int widgetType;

  TimerProgramWidget4(this.widgetType);

  @override
  _TimerProgramWidget4State createState() => _TimerProgramWidget4State();
}

class _TimerProgramWidget4State extends State<TimerProgramWidget4> {
  String title = "PROGRAMA 4";
  int index = 4;
  List<String> daysAdded = new List();
  TimerProgram4Bloc bloc;
  ...
  Widget build(BuildContext context) {
    bloc = BlocProvider.of<TimerProgram4Bloc>(context);
  ...
  Widget timer_program_widget() {
    ...
    return BlocBuilder<TimerProgram4Bloc, TimerProgram4State>(
