...
import '../../IconSvg.dart';
import '../blocs/temp_program_bloc.dart';
import '../temp_programa.dart';

class TimerProgramWidget extends StatefulWidget {
  int widgetType;

  TimerProgramWidget(this.widgetType);

  @override
  _TimerProgramWidgetState createState() => _TimerProgramWidgetState();
}

class _TimerProgramWidgetState extends State<TimerProgramWidget> {
  String title = "PROGRAMA 1";
  List<String> daysAdded = new List();
  TimerProgramBloc bloc;
  ...
  Widget build(BuildContext context) {
    bloc = BlocProvider.of<TimerProgramBloc>(context);
...
// En el builder usar un build con condicion
// build cuando se haga un save
  Widget timer_program_widget() {
    Color colorIcon, colorText;
    return BlocBuilder<TimerProgramBloc, TimerProgramState>(
