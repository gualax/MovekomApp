...
class TimerProgramWidget5 extends StatefulWidget {
  int widgetType;

  TimerProgramWidget5(this.widgetType);

  @override
  _TimerProgramWidget5State createState() => _TimerProgramWidget5State();
}

class _TimerProgramWidget5State extends State<TimerProgramWidget5> {
  String title = "PROGRAMA 5";
  List<String> daysAdded = new List();
  TimerProgram5Bloc bloc;
  TimerProgram timerProgram;
  GeneralTimerProgramBloc _generalTimerProgramBloc;
  int index = 5;
  @override
  Widget build(BuildContext context) {
    bloc = BlocProvider.of<TimerProgram5Bloc>(context);
  ...
  Widget timer_program_widget() {
    ...
    return BlocBuilder<TimerProgram5Bloc, TimerProgram5State>(
