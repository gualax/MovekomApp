...
import 'package:movekomapp/blocs/luces_salon_bloc.dart';
              ...
              children: [
                Positioned.fill(
                  ...
                  child: Align(
                    ...
                    child: iconSvgD("assets/icons/salon.svg", Colors.lightGreenAccent.withAlpha(state.valueDimer.round()+20), 60),
                  ),
                ),
                Positioned.fill(
