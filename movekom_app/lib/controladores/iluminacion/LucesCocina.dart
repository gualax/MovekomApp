...
import 'package:movekomapp/blocs/luces_cocina_bloc.dart';
...
class LucesCocina extends StatelessWidget {
  ...
  Widget cocina_widget(lucesCocinaBloc){
    return BlocBuilder(
        ...
        builder: (BuildContext context, LucesCocinaState state) {
          return Container(
            ...
            child: Stack(
              children: [
                Positioned.fill(
                  right: SizeConfig.h * 2, bottom: SizeConfig.v * 0.5,
                  child: Align(
                    alignment: Alignment.centerRight,
                    child: iconSvgD("assets/icons/kitchen.svg", Colors.lightGreenAccent.withAlpha(state.valueDimer.round() + 20), 60),
                  ),
                ),
                Positioned.fill(
                  left: SizeConfig.h * 2, bottom: SizeConfig.v * 0.5,
                  child: Align(
