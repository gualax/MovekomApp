      ...
      BlocBuilder<UpligthBloc,UplightState>(
        builder: ( context, state) {
          ...
          return GestureDetector(
            onTap: (){
              if(state.isEnabled){
                uplightBloc.add(DisableUplight());
              }else {
                uplightBloc.add(EnableUplight());
              }
            },
            child: MyContainer(
                ...
                children: [
                  MyPositioned.fill(
                    ...
                    child: Align(
                      ...
                      child: iconSvgD("assets/icons/tira_led.svg",state.isEnabled ? MyColors.principal.withAlpha(state.valueDimer.round()+ 20): MyColors.inactive.withAlpha(100) , 85),
                    ),
                  ),
                  MyPositioned.fill(
                    left: 30, bottom: 10,
                      ...
                      child: Container(
                        ...
                        child: SliderTheme(
                          ...
                          child: Slider(
                            ...
                            onChanged: (newValue) {
                              //   print(newValue);
                              uplightBloc.add(UpdateUplight(newValue,context));
                            },
                            min: 0,
                            max: 200,
                          ),
                    ...
                    child: Align(
                      ...
                      child: GestureDetector(
                        onHorizontalDragUpdate: (dragValue){
                          ...
                          uplightBloc.add(UpdateUplight(newVlue,context));
                        },
                        child: MyContainer(
