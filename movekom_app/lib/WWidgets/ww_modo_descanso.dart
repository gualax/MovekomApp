...
class WWModoDescanso extends StatelessWidget {
  bool isAdded;
  String title = "MODO DESCANSO";

  WWModoDescanso(this.isAdded);
  ModoDescansoBloc bloc;

  @override
  Widget build(BuildContext context) {
    bloc = BlocProvider.of<ModoDescansoBloc>(context);
          ...
          children: <Widget>[
            ...
            MyPositioned.fill(
                ...
                child: Align(
                  ...
                  child: iconSvgD(
                      "assets/icons/modo_descanso.svg", colorIcon, 50),
                )
            ),
          ],
