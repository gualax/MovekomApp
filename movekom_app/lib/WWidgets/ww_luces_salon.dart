...
class WWLucesSalon extends StatelessWidget {

  bool isAdded;
  String title = "LUZ SALON";

  WWLucesSalon(this.isAdded);
  LucesSalonBloc bloc;
  @override
  Widget build(BuildContext context) {
    bloc = BlocProvider.of<LucesSalonBloc>(context);
      ...
      BlocBuilder<LucesSalonBloc,LucesSalonState>(
          builder: ( context, state) {
            ...
            return InkWell(
              ...
              onTap: (){
                if (state.isEnabled) {
                  bloc.add(DisableLucesSalon());
                } else {
                  bloc.add(EnableLucesSalon());
                }
              },
              onLongPress: (){
                  ...
                  children: [
                    MyPositioned.fill(
                      ...
                      child: Align(
                        ...
                        child: iconSvgD("assets/icons/salon.svg", colorIcon, 70),
                      ),
                    ),
                    MyPositioned.fill(
                      left: 30, bottom: 10,
