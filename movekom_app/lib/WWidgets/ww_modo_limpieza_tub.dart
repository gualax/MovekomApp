...
class WWModoLimpiezaTuberias extends StatelessWidget {
  bool isAdded;
  WWModoLimpiezaTuberias(this.isAdded);
  String title = "MODO LIMPIEZA DE TUBERIAS";
  ModoLimpiezaBloc bloc;
  @override
  Widget build(BuildContext context) {
    bloc = BlocProvider.of<ModoLimpiezaBloc>(context);
    return _modo_limpieza_tub_ww();
  }

  Widget _modo_limpieza_tub_ww() {
          ...
          child: Stack(
            ...
            MyPositioned.fill(
                ...
                child: Align(
                  ...
                  child: iconSvgD("assets/icons/modo_limpieza.svg", colorIcon, 50),
                )
            ),
          ],
